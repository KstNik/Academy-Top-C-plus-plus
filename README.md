...
## ExaminationWorkUML 04

Задание: Выбрать один паттерн проектирования и описать его в реальном коде.

## ExaminationWorkOOP 05

Задание 1. Создайте систему управления персональными финансами.   
Система должна иметь следующие возможности: 1. Наличие разных кошельков и карт (дебетовых/кредитных);   
2. Пополнение кошельков и карт;   
3. Внесение затрат. Каждая затрата относится к определённой категории;   
4. Формирование отчётов по затратам и категориям:   
• день;   
• неделя;   
• месяц.   
5. Формирование рейтингов по максимальным суммам:   
• ТОП-3 затрат:   
неделя;   
месяц.   
• ТОП-3 категорий:   
неделя;   
месяц.   
6. Сохранение отчётов и рейтингов в файл.
