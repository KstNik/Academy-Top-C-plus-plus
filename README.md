...
Задание 1.		
Для класса String добавить перегрузки:
...
Задание 2.		
Реализуйте шаблонные методы класса Array для:		
• поиска максимума;		
• минимума;		
...
Задание 3.		
Реализуйте класс "Контакт", с именем, адресом и телефоном. Реализуйте класс "Телефонная книга", со списком контактов. Объявите все необходимые конструкторы и методы для работы с телефонной книгой и контактами. Добавьте необходимые перегрузки операторов для более удобного взаимодействия.
